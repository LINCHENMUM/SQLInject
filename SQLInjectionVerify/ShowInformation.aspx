<%@ Page Language="C#" MasterPageFile="~/mainMaster.master" AutoEventWireup="true"
    CodeFile="ShowInformation.aspx.cs" Inherits="ShowNewsInformation" Title="Untitled Page" %>
                ...
                <table>
                    <tr>
                        ...
                        <td style="width: 171px; text-align: right; font-size :12px">
                            <asp:LinkButton ID="firstPage" runat="server" Text="第一页" OnClick="firstPage_Click"></asp:LinkButton>
                        </td>
                        ...
                        <td style="width: 71px; text-align: right;">
                            <asp:LinkButton ID="lastPage" runat="server" Text="最后一页" Font-Underline="false" OnClick="lastPage_Click"></asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </td>
